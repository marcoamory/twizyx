              ...
              <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="dropdown">
		              ...
		              <ul class="dropdown-menu">
		                ...
		                <li class="divider"></li>
		                <li><a href="#">Encoder un nouveau véhicule</a></li>
		              </ul>
		
		            </li>
                    
                    <li><a href="" class="btn btn-round btn-default">Déconnexion</a></li>
               </ul>
        ...
        <div class="row">
            ...
            <div class="col-md-6 col-md-offset-3 col-md-12 text-center">
                <h1 class="hello text-center">
                   <a href="" style="line-height: 60px;">Vous aimez votre nouvelle <span class="texte_jaune">TwizyX</span> ?</a>
                   <small>
                 ...
                 <div class="actions">
                     <a class="btn btn-lg btn-info btn-fill" href="">Remboursez votre modification !</a>
                </div>
            </div>
        </div>
        <div class="space-30"></div>
